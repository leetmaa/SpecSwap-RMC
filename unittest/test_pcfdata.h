...
#ifndef __TEST_PCFDATA__
#define __TEST_PCFDATA__
...
class Test_PCFData : public CppUnit::TestCase {

public:

    CPPUNIT_TEST_SUITE( Test_PCFData );
    ...
    CPPUNIT_TEST( testCalculateBin );
    CPPUNIT_TEST( testGetRAndCalculateBin );
    CPPUNIT_TEST( testCalculatePartialHistogram );
    ...
    void testGetChi2New();
    void testGetR();
    void testCalculateBin();
    void testGetRAndCalculateBin();
    void testCalculatePartialHistogram();
