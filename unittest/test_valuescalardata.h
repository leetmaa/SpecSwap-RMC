...
#ifndef __TEST_VALUESCALARDATA__
#define __TEST_VALUESCALARDATA__
...
class Test_ValueScalarData : public CppUnit::TestCase {

public:

    CPPUNIT_TEST_SUITE( Test_ValueScalarData );
